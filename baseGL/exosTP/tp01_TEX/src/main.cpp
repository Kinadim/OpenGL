...
//layout (location = 0) in vec3 aPos;
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "TP 01 TEXTURATION", NULL, NULL);
    if (window == NULL)
        {
...
model = glm::rotate(model, (float)glfwGetTime() * glm::radians(2050.0f), glm::vec3(0.5f, 1.0f, 0.0f));
